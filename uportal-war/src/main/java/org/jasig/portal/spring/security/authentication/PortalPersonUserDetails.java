...
public class PortalPersonUserDetails implements UserDetails {
    ...
    protected final static Collection<GrantedAuthority> ANONYMOUS_AUTHORITIES = Collections
            .<GrantedAuthority> singletonList(new GrantedAuthorityImpl(
                    "ROLE_ANONYMOUS"));
    protected final static Collection<GrantedAuthority> AUTHENTICATED_AUTHORITIES = Collections
            .<GrantedAuthority> singletonList(new GrantedAuthorityImpl(
                    "ROLE_USER"));
